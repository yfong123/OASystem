 ...
 <form class="layui-form">
	 <div class="layui-form-item" style="margin-bottom:5px;">
	     ...
	     <div class="layui-inline">
	      <label class="layui-form-label">布署编号</label>
	      <div class="layui-input-inline">
	        <input type="text" name="frmDeploy" id="frmDeploy"
	  ...
	  <label class="layui-form-label">流程类型</label>
		<div class="layui-input-inline">
		     <select id="frmProc" name="frmProc" lay-filter="frmProc">
...
function updateSelect( id ){
	var $sel = $( id );
	var $dd = $sel.parent().find("dd");//dd 指 option标签
	console.log($dd.size());
...
var schFlds = [
  {key:'deploymentId',id:'#frmDeploy'},
  {key:'procCategory',id:'#frmProc'},
];
...
layui.use(
  ...
  table.render({
    ...
    ,cols: [[          //{ps} 表头
      ...
      {field: 'deplomentid', title: '布署编号', width:120},
      {field: 'proccategory', title: '流程类型', width:120},
