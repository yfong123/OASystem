...
layui.use(
  ...
  table.render({
    elem: '#demo'
    ,height: 580
    ,url: '${ctxPath}/Leave/jsonMyApproved?assignee=${user.id}' //数据接口
    ,title: '我已审批请假表'
    ,page: true //开启分页
    ...
    ,cols: [[     //表头         
	   ...
	   ,{field:'initiatorName', title:'发起人', width:85}
       ,{field:'assigneeName', title:'当前办理人', width:105} 
       ,{field:'startdate', title:'开始日期', width:115}
       ,{field:'enddate', title:'结束日期', width:115}
	   ,{field:'days', title:'天数', width:60}	   
       ,{field:'leavetype', title:'请假类型', width:110}
       ,{field:'createtime', title:'创建日期', width:110}
       ,{field:'finishtime', title:'完成日期', width:110}
       ,{field:'status', title:'流程状态', width:110}
