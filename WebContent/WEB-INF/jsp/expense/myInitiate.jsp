...
layui.use(
  ...
  table.render({
    elem: '#demo'
    ,height: 580
    ,url: '${ctxPath}/Expense/jsonMyInitiate?initiator=${user.id}' //数据接口
    ,title: '我的申请表'
    ,page: true //开启分页
    ,id:'myInitiateTbl'
    ...
    ,cols: [[     //表头
       ...
       ,{field:'orderdate', title:'开单日期', width:125}
       ,{field:'expensedate', title:'报销日期', width:125}
       ,{field:'money', title:'报销金额', width:95}
       ,{field:'orderdesc', title:'报销内容', width:125}
