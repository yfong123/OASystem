...
layui.use(
  ...
  table.render({
    elem: '#demo'
    ,height: 580
    ,url: '${ctxPath}/Expense/jsonWaitMyApprove?assigneeId=${user.id}' //数据接口
    ,title: '待我审批报销表'
    ,page: true //开启分页
    ...
    ,cols: [[     //表头                  
      ...
      ,{field:'taskid', title:'任务ID', width:125, fixed:'left'}
      ,{field:'initiatorName', title:'发起人', width:115, fixed:'left'}
      ,{field:'orderdate', title:'开单日期', width:125, fixed:'left'}
      ,{field:'expensedate', title:'报销日期', width:125, fixed:'left'}
      ,{field:'money', title:'报销金额', width:95, fixed:'left'}
      ,{field:'orderdesc', title:'报销内容', width:125, fixed:'left'}
  ...
  table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
    ...
    if(layEvent === 'detail'){
      ...
      window.location = '${ctxPath}/Expense/taskDetail?taskId='+ data['taskid'];
